...
tabItem(tabName = "gallery_product",
  ...
  fluidRow(
    box(
      ...
      width = 3,  # Mengurangi lebar box menjadi 3 untuk menampilkan 4 box dalam satu baris
      status = "primary",
      solidHeader = TRUE,
      img(src = "https://raw.githubusercontent.com/delagustiara24/ProjectMDS/main/Images/dela.jpg", width = "100%", style = "border-radius: 10px;"),
    ...
    box(
      ...
      status = "primary",
      solidHeader = TRUE,
      img(src = "https://raw.githubusercontent.com/delagustiara24/ProjectMDS/main/Images/rupmana.jpg", width = "100%", style = "border-radius: 10px;"),
    ...
    box(
      ...
      status = "primary",
      solidHeader = TRUE,
      img(src = "https://raw.githubusercontent.com/delagustiara24/ProjectMDS/main/Images/rizqi.jpg", width = "100%", style = "border-radius: 10px;"),
    ...
    box(
      ...
      status = "primary",
      solidHeader = TRUE,
      img(src = "https://raw.githubusercontent.com/delagustiara24/ProjectMDS/main/Images/mega.jpg", width = "100%", style = "border-radius: 10px;"),
